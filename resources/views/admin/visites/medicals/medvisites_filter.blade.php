        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="search-visites" action="{{route('admin.visitemed_results')}}" method="get">
                        <div class="form-row">
                            <div class="col">
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="col">
                                <label for="spec">Specialités</label>
                                <select name="spec[]" class="form-control form-control-lg" id="spec" multiple="multiple">
                                    @foreach($specialites as $spec)
                                        <option value="{{$spec->specialite_id}}">{{$spec->libelle}}</option>
                                    @endforeach
                                </select>
                            </div>
