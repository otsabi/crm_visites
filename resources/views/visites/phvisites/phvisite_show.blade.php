                    ...
                    <form class="forms-sample" >
                        ...
                        <div class="form-row pb-3">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" disabled id="med" value="{{$visite->pharmacie->libelle}} - {{$visite->pharmacie->zone_ph}}">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <a class="btn btn-secondary" href="{{route('phvisites.index')}}">Retour à la liste</a>
                            </div>
                        </div>
