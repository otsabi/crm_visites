        ...
        <div class="col-sm-12 grid-margin stretch-card">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="mdi mdi-account-badge-horizontal-outline"></i>&nbsp; Nouvelle visite pharmacie
                </div>

                <div class="card-body">
                    <form class="forms-sample" action="{{route('phvisites.store')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-row pb-3">
                            <div class="col-sm-12 col-md-6">
                                ...
                                <select class="form-control form-control-lg" id="pharma" name="pharma" required>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{asset('js/searchph.js')}}"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#plan').on('click',function (event) {
                ...
                Swal.fire({
                    title: 'Attention !',
                    text: 'Pour plannifier cette visite, vous devez vider le tableau des produits présentés !',
                    icon: 'warning',
