...
<div class="row">
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form class="forms-sample" action="{{route('pharmacies.store')}}" method="POST">
            ...
            @csrf
                <div class="form-row pb-3">
                    ...
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        <input type="text" name="pharmacie_nom" class="form-control {{$errors->has('pharmacie_nom') ? 'is-invalid':''}}" id="pharmacie_nom" placeholder="Pharmacie" required>
                    </div>
                    <div class="col-sm-12 col-md-4 mb-3">
                    ...
                    <div class="col-sm-12 col-md-4 mb-3">
                                ...
                                <input type="tel" class="form-control" name="pharmacie_tel" id="pharmacie_tel"  placeholder="Numéro de tél">
                    </div>
                </div>
                ...
                <div class="form-row pb-3">
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        <input type="address" name="pharmacie_adress" class="form-control {{$errors->has('pharmacie_adress') ? 'is-invalid':''}}" id="pharmacie_adress" placeholder="Pharmacie adresse" required >
                    </div>
                    <div class="col-sm-12 col-md-4 mb-3">
                            <label for="pharmacie_zone">Pharmacie zone</label>
                            <input type="pharmacie_zone" name="pharmacie_zone" class="form-control {{$errors->has('pharmacie_zone') ? 'is-invalid':''}}" id="pharmacie_zone" placeholder="Pharmacie zone" required>
                    </div>
                    <div class="col-sm-12 col-md-4 mb-3">
              ...
              <div class="form-row pb-3">
                    ...
                    <div class="col">
                            <a href="{{route('pharmacies.index')}}" class="btn btn-light">Annuler</a>
