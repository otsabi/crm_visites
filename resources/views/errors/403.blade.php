                ...
                <div class="col-lg-7 mx-auto text-white">
                    <div class="row align-items-center d-flex flex-row">
                        ...
                        <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                            <h2>Accès refusé !</h2>
                            <h3 class="font-weight-light">la page ou la ressource que vous essayiez d’atteindre est absolument interdite.</h3>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-12 text-center mt-xl-2">
                            <a class="text-white font-weight-medium" href="{{route('home')}}">Retour à l'accueil</a>
                        </div>
                    </div>
                    <div class="row mt-5">
